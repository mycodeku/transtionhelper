...
* [`/baseapp`](https://github.com/mycodeku/transtionhelper/tree/master/baseapp)
* [`/crypto`](https://github.com/mycodeku/transtionhelper/tree/master/crypto)
* [`/types`](https://github.com/mycodeku/transtionhelper/tree/master/types)
* [`/store`](https://github.com/mycodeku/transtionhelper/tree/master/store)

### Modules

* [`x/auth`](https://github.com/mycodeku/transtionhelper/tree/master/x/auth)
* [`x/bank`](https://github.com/mycodeku/transtionhelper/tree/master/x/bank)
* [`x/capability`](https://github.com/mycodeku/transtionhelper/tree/master/x/capability)
* [`x/staking`](https://github.com/mycodeku/transtionhelper/tree/master/x/staking)
* [`x/slashing`](https://github.com/mycodeku/transtionhelper/tree/master/x/slashing)
* [`x/evidence`](https://github.com/mycodeku/transtionhelper/tree/master/x/evidence)
* [`x/distribution`](https://github.com/mycodeku/transtionhelper/tree/master/x/distribution)
* [`x/ibc`](https://github.com/mycodeku/transtionhelper/tree/master/x/ibc)
* [`x/ibc-transfer`](https://github.com/mycodeku/transtionhelper/tree/master/x/ibc-transfer)
* [`x/mint`](https://github.com/mycodeku/transtionhelper/tree/master/x/mint)
...
also recommend you to read the [specification](https://github.com/mycodeku/transtionhelper/blob/master/docs/building-modules/README.md) of each module before digging into
the code.
...
* Tx signature verification (see [`x/auth/ante`](https://github.com/mycodeku/transtionhelper/tree/master/x/auth/ante))
...
1. Patches are prepared in private repositories for eligible releases of Cosmos SDK. See [Stable Release Policy](https://github.com/mycodeku/transtionhelper/blob/master/RELEASE_PROCESS.md#stable-release-policy) for a list of eligible releases.
