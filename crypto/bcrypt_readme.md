...
```bash
go test -v --bench github.com/mycodeku/transtionhelper/crypto/keys/mintkey
```
...
goos: linux
goarch: amd64
pkg: github.com/mycodeku/transtionhelper/crypto/keys/mintkey
...
PASS
ok  	github.com/mycodeku/transtionhelper/crypto/keys/mintkey	12.093s
```
