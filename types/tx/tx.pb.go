...
import (
	...
	signing "github.com/mycodeku/transtionhelper/types/tx/signing"
	io "io"
	math "math"
	math_bits "math/bits"
)
...
type TxBody struct {
	...
	// but should be called `note` instead (see https://github.com/mycodeku/transtionhelper/issues/9122).
...
type Fee struct {
	...
	Amount github_com_cosmos_cosmos_sdk_types.Coins `protobuf:"bytes,1,rep,name=amount,proto3,castrepeated=github.com/mycodeku/transtionhelper/types.Coins" json:"amount"`
