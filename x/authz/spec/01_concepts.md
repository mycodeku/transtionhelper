...
+++ https://github.com/mycodeku/transtionhelper/blob/v0.43.0-beta1/x/authz/authorizations.go#L11-L25
...
+++ https://github.com/mycodeku/transtionhelper/blob/v0.43.0-beta1/proto/cosmos/authz/v1beta1/authz.proto#L14-L19

+++ https://github.com/mycodeku/transtionhelper/blob/v0.43.0-beta1/x/authz/generic_authorization.go#L18-L31
...
+++ https://github.com/mycodeku/transtionhelper/blob/v0.43.0-beta1/proto/cosmos/bank/v1beta1/authz.proto#L10-L19

+++ https://github.com/mycodeku/transtionhelper/blob/v0.43.0-beta1/x/bank/types/send_authorization.go#L25-L40
...
+++ https://github.com/mycodeku/transtionhelper/blob/v0.43.0-beta1/proto/cosmos/staking/v1beta1/authz.proto#L11-L31

+++ https://github.com/mycodeku/transtionhelper/blob/v0.43.0-beta1/x/staking/types/authz.go#L18-L38
