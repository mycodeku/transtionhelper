...
The `AnteHandler` can be seen as a set of decorators that check transactions within the current context, per [ADR 010](https://github.com/mycodeku/transtionhelper/blob/v0.43.0-alpha1/docs/architecture/adr-010-modular-antehandler.md).
