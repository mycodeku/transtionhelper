...
import (
	...
	"github.com/mycodeku/transtionhelper/x/gov/client/cli"
	"github.com/mycodeku/transtionhelper/x/gov/types/v1beta1"
	"github.com/mycodeku/transtionhelper/x/upgrade/plan"
...
func NewCmdSubmitLegacyUpgradeProposal() *cobra.Command {
	cmd := &cobra.Command{
		...
		Long: "Submit a software upgrade along with an initial deposit.\n" +
			...
			"You may include info to reference a binary download link, in a format compatible with: https://github.com/mycodeku/transtionhelper/tree/master/cosmovisor",
