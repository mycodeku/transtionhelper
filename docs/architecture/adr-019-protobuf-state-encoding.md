...
* 2021 Feb 24: Remove mentions of `HybridCodec`, which has been abandoned in [#6843](https://github.com/mycodeku/transtionhelper/pull/6843).
...
After [extension discussion](https://github.com/mycodeku/transtionhelper/issues/6030),
...
```go
import "github.com/mycodeku/transtionhelper/codec"
...
message MsgSubmitEvidence {
  bytes submitter = 1
    [
      (gogoproto.casttype) = "github.com/mycodeku/transtionhelper/types.AccAddress"
    ];
...
1. https://github.com/mycodeku/transtionhelper/issues/4977
2. https://github.com/mycodeku/transtionhelper/issues/5444
