...
+++ https://github.com/mycodeku/transtionhelper/blob/v0.40.0-rc3/simapp/app.go#L145-L187
...
+++ https://github.com/mycodeku/transtionhelper/blob/v0.40.0-rc3/server/types/app.go#L48-L50
...
+++ https://github.com/mycodeku/transtionhelper/blob/v0.40.0-rc3/simapp/app.go#L464-L471
...
+++ https://github.com/mycodeku/transtionhelper/blob/v0.40.0-rc3/simapp/app.go#L454-L462
...
+++ https://github.com/mycodeku/transtionhelper/blob/v0.40.0-rc3/simapp/params/encoding.go#L9-L16
...
+++ https://github.com/mycodeku/transtionhelper/blob/590358652cc1cbc13872ea1659187e073ea38e75/simapp/encoding.go#L8-L19
...
+++ https://github.com/mycodeku/transtionhelper/blob/v0.40.0-rc3/proto/cosmos/bank/v1beta1/tx.proto#L10-L17
...
::: warning
A patch introduced in `go-grpc v1.34.0` made gRPC incompatible with the `gogoproto` library, making some [gRPC queries](https://github.com/mycodeku/transtionhelper/issues/8426) panic. As such, the Cosmos SDK requires that `go-grpc <=v1.33.2` is installed in your `go.mod`.
...
Please see [issue #8392](https://github.com/mycodeku/transtionhelper/issues/8392) for more info.
:::
