...
The SDK Baseapp's implementation of ABCI CheckTx, DeliverTx, and Baseapp's own Simulate methods use a middleware-based design. Middlewares can add logic to be executed before or after a transaction handler execution. Middlewares are like an `antehandler` with the added feature of being able to add post-transaction handler execution. Middlewares allow us to solve use cases like transaction Tips and refund unused gas (issue [#2150](https://github.com/mycodeku/transtionhelper/issues/2150)).

### Type Definition

The two following interfaces are the base of the middleware design, and are defined in types/tx:

+++ https://github.com/mycodeku/transtionhelper/blob/5491be27d02e796746bd78d3d08bd1b2a9b1deb2/types/tx/middleware.go#L62-L71

Where we define the following arguments and return types:

+++ https://github.com/mycodeku/transtionhelper/blob/5491be27d02e796746bd78d3d08bd1b2a9b1deb2/types/tx/middleware.go#L25-L60
